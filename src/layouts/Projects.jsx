        ...
        <div>
            <div id="project" className="z-30 bg-gradient-to-l from-blue-400 lg:to-blue-200 to-blue-300 dark:bg-gradient-to-r dark:from-blue-500 dark:to-blue-300  transition-color duration-500">
                <div className="xl:container mx-auto lg:px-10">
                    ...
                    <div className="lg:mx-auto pt-20 flex lg:flex-row flex-col items-center justify-center lg:space-x-10">
                        <ProjectsCard
                        name="Smart Card"
                        img={smartCard}
                        />
                    ...
                    <div className={`${showMore ? "lg:mx-auto pb-10 flex lg:flex-row flex-col items-center justify-center lg:space-x-10 transition-all ease-in-out duration-500" : "overflow-hidden h-0 opacity-0 transition-all ease-in-out duration-500"}`}>
                        <ProjectsCard />
                        <ProjectsCard />
                        <ProjectsCard />
                    </div>
            ...
            <div id="project" className={`${showMore ? "bg-gradient-to-l from-blue-400 lg:to-blue-200 to-blue-300 dark:bg-gradient-to-r dark:from-blue-500 dark:to-blue-300  transition-all transform duration-500" : "hidden"}`}>
                <div className="xl:container mx-auto lg:px-10">
                    ...
                    <div className="lg:mx-auto pb-10 flex lg:flex-row flex-col items-center justify-center lg:space-x-10">
                        <ProjectsCard />
                        <ProjectsCard />
                        <ProjectsCard />
                    </div>
