                ...
                <div className="lg:mx-auto pt-20 flex lg:flex-row flex-col items-center justify-between">
                    <div className="lg:w-3/5 mx-auto w-full" align="center">
                        <form onSubmit={sendEmail}>
                            <input type="text" className="form-input my-5 duration-300 transition-all ease-in-out w-full rounded-lg shadow-xl outline-none" placeholder="Nama" name="nama" required/>
                            <input type="email" className="form-input my-5 duration-300 transition-all ease-in-out w-full rounded-lg shadow-xl outline-none" placeholder="Email" name="email" required/>
                            <textarea type="text" rows="5" className="form-textarea my-5 duration-300 transition-all ease-in-out w-full rounded-lg shadow-xl outline-none" placeholder="Pesan" name="pesan" required/>
