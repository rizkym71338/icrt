...
const Footer = () => {
    ...
    const github = <svg className="fill-current text-blue-500 w-full" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    const instagram = <svg className="fill-current text-blue-500 w-full" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    const gmail = <svg className="fill-current text-blue-500 w-full" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    const youtube = <svg className="fill-current text-blue-500 w-full mt-2" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M48.953 6.276C48.67 5.06483 48.1185 3.9683 47.3574 3.10297C46.5748 2.21103 45.6156 1.57301 44.5703 1.24912C40.6583 0.0123893 24.9854 0.0123895 24.9854 0.0123895C18.4516 -0.0767735 11.9193 0.315388 5.42556 1.18666C4.38026 1.53448 3.42283 2.18676 2.63843 3.08548C1.8677 3.97493 1.30944 5.07175 1.01782 6.2735C0.31727 10.8001 -0.0231027 15.3962 0.00128563 20C-0.023711 24.5996 0.315827 29.1943 1.01782 33.7265C1.30319 34.9232 1.85937 36.015 2.63218 36.897C3.40499 37.779 4.36737 38.4161 5.42556 38.7533C9.38961 39.9876 24.9854 39.9876 24.9854 39.9876C31.5276 40.0769 38.0682 39.6847 44.5703 38.8133C45.6156 38.4894 46.5748 37.8514 47.3574 36.9595C48.1281 36.0775 48.676 34.9807 48.951 33.7864C49.6698 29.2616 50.0193 24.6636 49.9946 20.0575C50.0486 15.4318 49.6996 10.8121 48.953 6.2735V6.276ZM20.0028 28.5547V11.4478L33.0427 20.0025L20.0028 28.5547Z" />
    </svg>
