            ...
            <div className="lg:mx-auto mx-5 lg:py-20 pt-10 flex lg:flex-row flex-col items-center justify-center">
                ...
                <div data-aos="fade-up-left" className="lg:w-1/2 lg:mx-10 w-full">
                    <div className="lg:mb-32 mb-8">
                        <span className="font-bold text-black text-xl dark:text-gray-200">Hackathon Yogyakarta</span>
                    ...
                    <div className="lg:mb-32 mb-8">
                        <span className="font-bold text-black text-xl dark:text-gray-200">Muslim Hackfest</span>
                        <p className="lg:text-lg text-sm text-gray-700 dark:text-gray-300 duration-500">
                    ...
                    <div className="lg:mb-32 mb-8">
                        <span className="font-bold text-black text-xl dark:text-gray-200">Kopiconcrete 2021 : Internet of Things Internasional Contest</span>
                        <p className="lg:text-lg text-sm text-gray-700 dark:text-gray-300 duration-500">
