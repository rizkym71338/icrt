...
const Structures = () => {
    ...
    return (
        <div>
            <div id="structure" className="bg-gradient-to-l from-blue-400 md:to-blue-200 to-blue-300 dark:bg-gradient-to-r dark:from-blue-500 dark:to-blue-300  transition-color duration-500">
            ...
            <div className={`${showMore ? "bg-gradient-to-l from-blue-400 md:to-blue-200 to-blue-300 dark:bg-gradient-to-r dark:from-blue-500 dark:to-blue-300  transition-color duration-500" : "hidden"}`}>
