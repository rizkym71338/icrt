...
const Github = ({ width, height }) => {
  return (
    <svg
      width={width}
      height={height}
      className="cursor-pointer text-slate-700 dark:text-slate-100 hover:text-primary-500 group-hover:text-primary-500 dark:hover:text-primary-500 transition-300"
      viewBox="0 0 24 25"
      fill="currentColor"
