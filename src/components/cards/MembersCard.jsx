            ...
            <div className="items-center shadow-xl p-6 my-14 justify-between w-64 mx-auto rounded-xl pb-3 bg-gradient-to-b from-blue-400 to-white dark:from-blue-600 dark:to-blue-400 transition-all transform hover:scale-105 duration-500">
                ...
                <div className="text-center">
                    ...
                    <div className="flex flex-row my-3 mx-6 justify-between">
                        <a target="_blank" href={props.facebook} className="transform transition-all hover:scale-110">
                            <svg className="fill-current text-blue-500 dark:text-blue-900" width="31" height="30" viewBox="0 0 31 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a target="_blank" href={props.github} className="transform transition-all hover:scale-105">
                            <svg className="fill-current text-blue-500 dark:text-blue-900" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a target="_blank" href={props.gmail} className="transition-all transform hover:scale-105">
                            <svg className="fill-current text-blue-500 dark:text-blue-900" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a target="_blank" href={props.instagram} className="transform transition-all hover:scale-105">
                            <svg className="fill-current text-blue-500 dark:text-blue-900" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
