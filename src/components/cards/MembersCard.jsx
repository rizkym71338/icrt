                ...
                <div className="text-center">
                    ...
                    <div className="flex flex-row my-3 mx-6 justify-between">
                        <a href={props.facebook} className="transform transition-all hover:scale-110">
                            <svg className="fill-current text-blue-500 dark:text-gray-800" width="31" height="30" viewBox="0 0 31 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href={props.github} className="transform transition-all hover:scale-105">
                            <svg className="fill-current text-blue-500 dark:text-gray-800" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
