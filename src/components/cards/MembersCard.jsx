...
const MembersCard = (props) => {
    return (
        <div>
            ...
            <div className="items-center shadow-xl p-6 my-14 justify-between w-64 mx-auto rounded-xl pb-3 bg-gradient-to-b from-blue-400 to-white dark:to-gray-200 transition-all transform hover:scale-105 duration-300">
                <img
                    src={Orang1}
                ...
                <div className="text-center">
                    ...
                    <p className="my-1 mx-3 text text-gray-900">
                        {props.divisi}
                    </p>
                    <p className="my-1 mx-3 text-sm text-gray-700">
                        {props.status}
                    </p>
                    <p className="my-1 mx-3 text-sm text-gray-700">
                        {props.jurusan}
                    </p>
                    <div className="flex flex-row mb-9 mt-3 mx-6 justify-between">
                        <a href={props.facebook} className="transform transition-all hover:scale-110">
                            <svg className="fill-current text-blue-500" width="31" height="30" viewBox="0 0 31 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M5.66041 0C2.52479 0 0 2.44335 0 5.47782V24.5222C0 27.5567 2.52479 30 5.66041 30H16.3264V18.2719H13.1217V14.0494H16.3264V10.4419C16.3264 7.60764 18.2198 5.00532 22.5816 5.00532C24.3476 5.00532 25.6535 5.16939 25.6535 5.16939L25.5508 9.11253C25.5508 9.11253 24.2189 9.10035 22.7656 9.10035C21.1927 9.10035 20.9405 9.80169 20.9405 10.966V14.0494H25.6757L25.4694 18.2719H20.9405V30.0001H25.3396C28.4752 30.0001 31 27.5567 31 24.5222V5.47785C31 2.44338 28.4752 3e-05 25.3396 3e-05H5.66038L5.66041 0Z"/>
                            </svg>
                        </a>
                        <a href={props.github} className="transform transition-all hover:scale-105">
                            <svg className="fill-current text-blue-500" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
