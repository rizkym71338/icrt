...
const CardMember = ({
  ...
  return (
    <div className="flex flex-col items-center mx-auto p-5 space-y-5 text-center scale-90 bg-white w-[360px] md:scale-100 dark:bg-slate-900 drop-shadow-xl rounded-3xl transition-500 group">
      <div className="flex items-center justify-center h-64 rounded-3xl bg-slate-300 dark:bg-slate-400 group-hover:bg-primary-300 dark:group-hover:bg-primary-400 w-80 transition-500">
