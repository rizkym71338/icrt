          ...
          <div className="flex flex-col items-center justify-between pt-10 lg:w-1/2 lg:mx-auto lg:pt-20">
            ...
            >
              <input
                type="text"
                name="nama"
                className="block w-full p-6 text-sm bg-white border-2 text-slate-900 rounded-3xl ring-primary-500 border-primary-500 dark:bg-slate-900 dark:placeholder-slate-100 dark:text-slate-100 dark:ring-primary-500 dark:border-primary-500"
              ...
              <div className="flex justify-start">
                <button
                  type="submit"
                  className="justify-end px-10 py-3 font-bold text-white shadow-xl dark:text-slate-900 transition-300 bg-primary-500 dark:bg-primary-600 rounded-3xl hover:bg-primary-700"
                >
                  Kirim
                </button>
              </div>
